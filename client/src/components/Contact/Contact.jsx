...
export default function Contact() {
  ...
  const sendEmail = (e) => {
    ...
    emailjs.sendForm('gmail', 'template_or9mjrn', e.target, 'user_GdBu7T9DTHFnIo5cvAyNk')
      .then((result) => {
                  ...
                  <form action="" onSubmit={sendEmail} className={s.contForm}>
                    ...
                    <div className={s.formWords}>
                      <p className={s.parrafito}>
                          Hola como estas! un gusto tenerte por aqui. </p>
                      <p>Este formulario fue creado para que puedas contactarte con el soporte de HLearning y 
